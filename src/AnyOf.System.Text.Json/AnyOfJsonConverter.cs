...
public class AnyOfJsonConverter : JsonConverter<object?>
{
    ...
    public override object? Read(ref Utf8JsonReader reader, Type? typeToConvert, JsonSerializerOptions options)
    {
        ...
        return Activator.CreateInstance(typeToConvert.GetNonNullableType(), value);
    }
    ...
    {
        return objectType.FullName?.StartsWith("AnyOfTypes.AnyOf`") == true || objectType.FullName?.StartsWith("System.Nullable`1[[AnyOfTypes.AnyOf`") == true;
    }
